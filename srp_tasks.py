...
# Abstract Class สำหรับกำหนดรูปแบบการเก็บข้อมูล (ตามหลัก OCP)
...
# Concrete Class สำหรับการบันทึกลงไฟล์ (ตามหลัก SRP)
...
# TaskManager ปรับปรุงให้รับ Storage แบบ Dependency Injection
class TaskManager:
    ...
    # แก้ไข add_task ใน Class TaskManager
